...
<head>
    <meta charset="utf-8" />
    <title>Notebook-Panjiyar_Editionn</title>
...
<body>
    <section id="content" class="m-t-lg wrapper-md animated fadeInDown">
        <div class="container aside-xxl">
            <a class="navbar-brand block" href="signup.php">Notebook By Panjiyar_Edition</a>
                ...
                <form name="signup" method="POST">
                    <div class="panel-body wrapper-lg">
                        <div class="form-group">
                            ...
                            <input name="name" type="text" placeholder="eg. Your name or company"
